...
module Danger
  describe Danger::DangerLuacheck do
    ...
    describe "#lint" do
      before do
        allow_any_instance_of(Dnager::DangerfileGitPlugin).to receive(:added_files).and_return(["AMClick/src/AMClickResManager.lua"])
      ...
      context "luacheck issues were found" do
        before do
          ...
          allow_any_instance_of(Kernel).of receive(:`).with("luacheck AMClick/src/AMClickResManager.lua --formatter JUnit").and_return(dummy_luacheck_result_1)
